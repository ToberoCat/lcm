 ...
 */
typedef void(*exlcm_example_t_handler_t)(
    const lcm_recv_buf_t *rbuf, const char *channel,
    const exlcm_example_t *msg, void *userdata);
 ...
 */
exlcm_example_t_subscription_t* exlcm_example_t_subscribe(
    lcm_t *lcm, const char *channel, exlcm_example_t_handler_t handler, void *userdata);
 ...
 * @return 0 on success, <0 if an error occured
 */
int exlcm_example_t_subscription_set_queue_capacity(
    exlcm_example_t_subscription_t* subs, int num_messages);
...
int __exlcm_example_t_encode_array(
    void *buf, int offset, int maxlen, const exlcm_example_t *p, int elements);
int __exlcm_example_t_decode_array(
    const void *buf, int offset, int maxlen, exlcm_example_t *p, int elements);
